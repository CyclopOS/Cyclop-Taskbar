/*
 * Cyclop-Taskbar extension for Gnome 3
...
function enable() {
    ...
    global.CyclopTaskbar = {};
    Signals.addSignalMethods(global.CyclopTaskbar);
...
function _enable() {
    ...
    Me.settings = Convenience.getSettings('org.gnome.shell.extensions.cyclop-taskbar');
...
function disable(reset) {
    ...
    if (!reset) {
        ...
        delete global.CyclopTaskbar;

        // Re-enable Ubuntu Dock if it was disabled by Cyclop Taskbar
