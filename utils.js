...
var defineClass = function (classDef) {
    ...
    if (Config.PACKAGE_VERSION < '3.31.9') {
        if (parentProto && (classDef.Extends.name || classDef.Extends.toString()).indexOf('CyclopTaskbar.') < 0) {
...
var GlobalSignalsHandler = defineClass({
    Name: 'CyclopTaskbar.GlobalSignalsHandler',
...
var InjectionsHandler = defineClass({
    Name: 'CyclopTaskbar.InjectionsHandler',
    Extends: BasicHandler,
...
var TimeoutsHandler = defineClass({
    Name: 'CyclopTaskbar.TimeoutsHandler',
    Extends: BasicHandler,
...
var notify = function(text, iconName, action, isTransient) {
    ...
    let notification = new MessageTray.Notification(source, 'Cyclop Taskbar', text);
...
var DominantColorExtractor = defineClass({
    Name: 'CyclopTaskbar.DominantColorExtractor',
