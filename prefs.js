...
const SCHEMA_PATH = '/org/gnome/shell/extensions/cyclop-taskbar/';
...
const Settings = new Lang.Class({
    Name: 'CyclopTaskbar.Settings',

    _init: function() {
        this._settings = Convenience.getSettings('org.gnome.shell.extensions.cyclop-taskbar');
    ...
    _showFileChooser: function(title, params, acceptBtn, acceptHandler) {
        ...
        if (dialog.run() == Gtk.ResponseType.ACCEPT) {
            try {
                ...
                log('error from cyclop-taskbar filechooser: ' + e);
            }
        }
