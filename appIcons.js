...
var taskbarAppIcon = Utils.defineClass({
    Name: 'CyclopTaskbar.TaskbarAppIcon',
    ...
    popupMenu: function() {
        ...
        this._menu.actor.add_style_class_name('CyclopTaskbarSecondaryMenu');
        this._menu.popup();
...
var taskbarSecondaryMenu = Utils.defineClass({
    Name: 'CyclopTaskbar.SecondaryMenu',
...
var ShowAppsIconWrapper = Utils.defineClass({
    Name: 'CyclopTaskbar.ShowAppsIconWrapper',
...
var MyShowAppsIconMenu = Utils.defineClass({
    Name: 'CyclopTaskbar.ShowAppsIconMenu',
    ...
    _dtpRedisplay: function() {
        ...
        let settingsMenuItem = this._appendMenuItem(_('Cyclop Panel Settings'));
