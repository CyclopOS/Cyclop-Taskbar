...
var taskbarActor = Utils.defineClass({
    Name: 'CyclopTaskbar-TaskbarActor',
    Extends: St.Widget,

    _init: function(delegate) {
        this._delegate = delegate;
        this._currentBackgroundColor = 0;
        this.callParent('_init', { name: 'CyclopTaskbarTaskbar',
...
var taskbar = Utils.defineClass({
    ...
    _init : function(panel) {
        ...
        this._scrollView = new St.ScrollView({ name: 'CyclopTaskbarScrollview',
...
const TaskbarItemContainer = Utils.defineClass({
    Name: 'CyclopTaskbar-TaskbarItemContainer',
...
var DragPlaceholderItem = Utils.defineClass({
    Name: 'CyclopTaskbar-DragPlaceholderItem',
    Extends: St.Widget,
